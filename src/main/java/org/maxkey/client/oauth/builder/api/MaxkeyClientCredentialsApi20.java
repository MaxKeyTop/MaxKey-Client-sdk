 ...
 * OAuth 2.0 api.
 */
public class MaxkeyClientCredentialsApi20 extends DefaultApi20 {
    ...
    private static final String AUTHORIZE_PARAM = "&client_id=%s&client_secret=%s";

    public MaxkeyClientCredentialsApi20(String accessTokenUrl) {
        super();
...
/*
    ...
    */
    ...
    public String getAccessTokenEndpoint() {
        if (accessTokenUrl.indexOf("?") > 0) {
            return accessTokenUrl + "&" + AUTHORIZE_PARAM;
        } else {
            return accessTokenUrl + "?" + AUTHORIZE_PARAM;
        }
    }
    ...
    public String toString() {
        return "OAuthApi20 [accessTokenUrl=" + accessTokenUrl + ", grantType=" + grantType + ", scope=" + scope + "]";
    }

    @Override
    public String getAuthorizationUrl(OAuthConfig config) {
        return String.format(getAccessTokenEndpoint(),config.getApiKey(),config.getApiSecret());
    }
